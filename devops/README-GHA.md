...
2. Go to your repository at [fosten/plone-mountain-site](https://github.com/fosten/plone-mountain-site).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `lillymountain.com` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | lillymountain.com | The hostname or IP address of your Docker Swarm manager. |
...
- [Backend Tests Workflow](https://github.com/fosten/plone-mountain-site/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/fosten/plone-mountain-site/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/fosten/plone-mountain-site-backend`) and Frontend (`ghcr.io/fosten/plone-mountain-site-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of lillymountain.com](https://github.com/fosten/plone-mountain-site/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/lillymountain.com.yml` stack.
