...
from plone.mountain_site.interfaces import IBrowserLayer
...
site_id = "Plone"
payload = {
    "title": "Plone Mountain Site",
    "profile_id": _DEFAULT_PROFILE,
    "extension_ids": [
        "plone.mountain_site:default",
    ],
    "setup_content": False,
    "default_language": "en",
    "portal_timezone": "UTC",
...
if site_id not in app.objectIds():
    ...
    if EXAMPLE_CONTENT:
        ...
        portal_setup.runAllImportStepsFromProfile("plone.mountain_site:initial")
        transaction.commit()
    app._p_jar.sync()
