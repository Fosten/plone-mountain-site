...
build-acceptance-servers: ## Build Acceptance Servers
	...
	@docker build backend -t fosten/plone-mountain-site-backend:acceptance -f backend/Dockerfile.acceptance
	@echo "Build acceptance frontend"
	@docker build frontend -t fosten/plone-mountain-site-frontend:acceptance -f frontend/Dockerfile
...
start-acceptance-servers: build-acceptance-servers ## Start Acceptance Servers
	...
	@docker run --rm -p 3000:3000 --name plone-mountain-site-frontend-acceptance --link plone-mountain-site-backend-acceptance:backend -e RAZZLE_API_PATH=http://127.0.0.1:55001/plone -e RAZZLE_INTERNAL_API_PATH=http://backend:55001/plone -d fosten/plone-mountain-site-frontend:acceptance
